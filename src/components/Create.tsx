...
// import { MapContainer as Map, Marker, TileLayer, AttributionControl, useMapEvents } from 'react-leaflet';
...
function Create() {
  ...
  //     const {latlng: {lat: latitude}, latlng: {lng: longitude}} = e;
    ...
    <div id="page-create-landmark">
      <main>
        <form className="create-landmark-form">
          ...
          <fieldset>
            <legend>Pàgina em mantenção</legend>
