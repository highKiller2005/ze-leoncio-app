    ...
    <main className="h-screen flex flex-col justify-center">
      {user ? (
        <div className="flex gap-2 fixed bottom-3 sm:bottom-auto sm:top-3 right-1 z-50">
          <Link href="/adicionar" className="flex items-center bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-sm leading-6 font-medium py-2 px-3 rounded-lg">Adicionar ponto</Link>
          <div
            className="flex gap-2 border-2  p-2 bg-white rounded-md text-xl font-bold z-50 bg-gradient-to-r text-orange-400 px-3 py-2"
          >
            <Image src={user.photoURL} width={50} height={50} alt="" className="rounded-full" />
